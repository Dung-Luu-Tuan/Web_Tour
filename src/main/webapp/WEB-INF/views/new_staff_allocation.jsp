...
<body>
    <div align="center">
        <h2>Thêm phân bổ nhân viên mới trong đoàn</h2>
        <form:form action="${pageContext.request.contextPath}/saveNewStaffAllocation" method="post" modelAttribute="staffAllocationAdd">
            <table border="0" cellpadding="5">
                ...
                <tr>
                    <td>Mã nhân viên: </td>
                    <td><form:input path="manhanvien" /></td>
                </tr>
                <tr>
                    <td>Nhiệm vụ: </td>
